...
const FAQ = () => {
  ...
  const faqAnswers = [
    "The answer to the first question. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.",
    "The answer to the second question. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.",
    "The answer to the third question. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.",
  ];

  return (
    <div className="py-[5rem]" id="faq">
        ...
        <div className="mt-[2rem]">
          <ul>
            {faqData.map((question, index) => (
              <li key={index} className="text-left mb-6">
                <div className="flex flex-row items-start mb-5">
                  <div className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-green-400 text-white border-4 border-green-200 text-xl font-semibold">
                    <svg
                      width="30px"
                      fill="white"
                      height="30px"
                  ...
                  <div
                    className="bg-green-100 p-5 px-10 w-full flex items-center justify-between cursor-pointer rounded-lg"
                ...
                {openIndex === index && (
                  <div className="flex flex-row items-start">
                    ...
                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-green-400 text-white border-4 border-green-200 text-xl font-semibold">
                      <svg
                        height="25px"
                        fill="white"
                        version="1.1"
